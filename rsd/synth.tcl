...
synth_design -top ${TOP_NAME} -part $DEVICE_NAME -fanout_limit 10000 \
    ...
    -include_dir rsd/Processor/Src/ \
    -verilog_define name=RSD_SYNTHESIS=1 \
	-verilog_define name=RSD_SYNTHESIS_VIVADO=1 \
	-verilog_define name=RSD_SYNTHESIS_ZEDBOARD=1 \
	-verilog_define name=RSD_USE_EXTERNAL_MEMORY=1 \
	-verilog_define name=RSD_DISABLE_DEBUG_REGISTER=1 \
	-verilog_define name=RSD_MARCH_FP_PIPE=1 \
    -retiming
